...
export const HeatMap2 = ({
    ...
    return (
        <div className='map relative'>
            <MapContainer className={"map " + className} center={center} zoom={ZOOM} scrollWheelZoom={false} minZoom={ZOOM}>
...

            {
                <div className='absolute bottom-1 left-3 sm:right-6 z-[1] items-end select-none'>
                    <input type="checkbox" checked={showDensityBased} onClick={() => setShowDensityBased(!showDensityBased)} /><span onClick={() => setShowDensityBased(!showDensityBased)} className="cursor-pointer"> Show Population Density Based </span>
                </div>
            }
