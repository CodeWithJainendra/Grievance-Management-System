...
import { Home, Profile, History, Notifications, Grievances, Category, RCA, Spatial, Saved, QueryGrievances, Read } from "@/pages/dashboard";
...
export const routes = [
  {
    ...
    pages: [
      ...
      {
        icon: <FlagIcon {...icon} />,
        name: "Redressal Flagging",
        path: "/redressal-flagging",
        element: <RedressalFlagging />,
      },
...

      {
        ...
        element: <GraphicalAnalysis />,
      },

      {
        icon: <ReceiptLongIcon {...icon} />,
